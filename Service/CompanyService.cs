...
namespace Service
{
    internal sealed class CompanyService : ICompanyService
    {
        ...
        {
            var company = await GetCompanyAndCheckIfItExists(
                companyId, trackChanges);
            ...
            IEnumerable<Guid> ids, bool trackChanges)
        {
            ...
            var companyEntities = await _repository.Company
                .GetByIdsAsync(ids, trackChanges);
        ...
        public async Task UpdateCompanyAsync(
            ...
            bool trackChanges)
        {
            var companyEntity = await GetCompanyAndCheckIfItExists(
                companyId, trackChanges);
        ...
        {
            var companyEntity = 
                await _repository.Company.GetCompanyAsync(id, trackChanges);
